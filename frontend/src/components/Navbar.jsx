    ...
    <>
      <header className="bg-[var(--surface)] border-b-2 border-[var(--line)] fixed w-full top-0 z-40 transition-colors">
        <div className="container mx-auto px-4 h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              {authUser ? (
                <>
                  <Link
                    to="/settings"
                    className="hidden lg:inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold text-[var(--primary-text)] border-2 border-[var(--line)] hover:shadow-[3px_3px_0px_0px_var(--line)] hover:-translate-y-0.5 transition-all bg-[var(--surface)]"
                  >
                  ...
                  <button
                    className="hidden lg:inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold text-red-500 border-2 border-red-500/40 bg-red-500/10 hover:shadow-[3px_3px_0px_0px_rgba(239,68,68,0.3)] hover:-translate-y-0.5 hover:bg-red-500/20 transition-all cursor-pointer"
          ...
          {authUser && !isLanding && mobileAppOpen && (
            <nav className="lg:hidden pb-4 flex flex-col gap-1 border-t-2 border-[var(--line)]/10 pt-3">
              {appSections.map((section) => {
                ...
                return (
                  <Link
                    ...
                    className={`inline-flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-bold border-2 transition-all ${
                      isActive
                        ? "bg-[var(--accent)] text-black border-[var(--line)] font-extrabold"
              ...
              <div className="my-2 border-t-2 border-[var(--line)]/10" />
              <Link
                to="/settings"
                onClick={() => setMobileAppOpen(false)}
                className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-bold text-[var(--primary-text)] border-2 border-transparent hover:border-[var(--line)] hover:bg-[var(--accent)]/10 transition-all"
              >
                <Settings className="w-4 h-4" />
                Settings
              </Link>
              ...
              <button
                ...
                className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-bold text-red-500 border-2 border-red-500/40 bg-red-500/10 hover:bg-red-500/20 transition-all cursor-pointer"
              >
                <LogOut className="w-4 h-4" />
                Logout
              </button>
        ...
        {authUser && !isLanding && !location.pathname.startsWith("/room") && (
          <nav className="lg:hidden bg-[var(--surface)] border-t-2 border-[var(--line)]/10">
