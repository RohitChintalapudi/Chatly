...
const GamesPage = () => {
  return (
    <div className="min-h-screen bg-[var(--surface)] relative overflow-hidden transition-colors pt-32 xl:pt-24 pb-10 px-2 sm:px-4">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="bg-[var(--surface)] rounded-3xl border-2 border-[var(--line)] shadow-[6px_6px_0px_0px_var(--line)] overflow-hidden min-h-[calc(100vh-10rem)] flex flex-col">
          <GamesSection />
        </div>
      </div>
