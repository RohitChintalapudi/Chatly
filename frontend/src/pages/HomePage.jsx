...
const HomePage = () => {
  ...
  return (
    <div className="h-screen bg-[var(--surface)] relative overflow-hidden transition-colors">
      ...
      <div className="relative z-10 flex items-center justify-center pt-28 lg:pt-20 px-0 sm:px-4">
        ...
        <div className="bg-[var(--surface-muted)] rounded-none sm:rounded-2xl border-y-2 sm:border-2 border-[var(--line)] w-full max-w-6xl h-[calc(100dvh-8rem)] overflow-hidden shadow-none sm:shadow-[4px_4px_0px_0px_var(--line)] transition-colors relative">
          <div className="flex h-full sm:rounded-2xl overflow-hidden">
            <Sidebar />
