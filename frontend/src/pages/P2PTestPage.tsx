...
export const P2PTestPage: React.FC = () => {
  ...
  if (isTransferring && store.metadata) {
    return (
      <div className="pt-32 lg:pt-24 px-6 pb-6 max-w-xl mx-auto min-h-[calc(100vh-6rem)] flex flex-col justify-start">
  ...
  if (store.status === "COMPLETED" && store.metadata) {
    return (
      <div className="pt-32 lg:pt-28 px-6 pb-6 max-w-md mx-auto min-h-[calc(100vh-6rem)]">
  ...
  if (store.status === "FAILED") {
    return (
      <div className="pt-32 lg:pt-28 px-6 pb-6 max-w-sm mx-auto min-h-[calc(100vh-6rem)]">
  ...
  return (
    <div className="pt-32 lg:pt-24 px-6 pb-6 max-w-lg mx-auto min-h-[calc(100vh-6rem)] flex flex-col justify-start">
      {/* Page Header */}
