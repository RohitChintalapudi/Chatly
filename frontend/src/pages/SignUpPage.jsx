        ...
        <div className="bg-[var(--surface)] rounded-3xl border-2 border-[var(--line)] p-6 sm:p-7 shadow-[0_0_40px_color-mix(in_srgb,var(--accent)_15%,transparent)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-3.5">
            <div className="space-y-1">
              <label className="text-xs sm:text-sm font-extrabold text-[var(--primary-text)]">Full Name</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                  <User className="h-4.5 w-4.5 text-[var(--secondary-text)]" />
                </div>
                <input
                  type="text"
                  autoComplete="name"
                  className="w-full pl-10 pr-3.5 py-2 sm:py-2.5 rounded-xl border-2 border-[var(--line)] bg-[var(--surface)] text-[var(--primary-text)] font-medium text-sm placeholder:text-[var(--secondary-text)] focus:outline-none focus:border-[var(--accent)] transition-colors"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2 sm:py-2.5 rounded-xl border-2 border-[var(--line)] bg-[var(--surface)] text-[var(--primary-text)] font-medium text-sm placeholder:text-[var(--secondary-text)] focus:outline-none focus:border-[var(--accent)] transition-colors"
                  placeholder="••••••••"
